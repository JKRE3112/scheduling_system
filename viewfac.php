...
// Fetch data from the demo table and join with the users table
$sql = "SELECT users.usersId, users.usersType, users.usersFName, users.usersLName, users.usersUid
        FROM demo
        INNER JOIN users ON demo.usersUid = users.usersUid";
...
<script>
    ...
    $('tbody').on('click', '.btn-dark', function() {
        var usersUid = $(this).data('id');
